    ...
    <Box sx={{ backgroundColor: "#fff", padding: "1rem" }}>
      ...
      <div style={{ padding: "0.5rem 1.5rem" }}>
        <Typography variant="h7">
          Render International Education Consultancy PVT. LTD. is an Educational
          Consultancy in Nepal. A centre for academic and career counseling,
          migration service, and standardized and proficiency test preparation
          with more than 3 years of expertise, We specialize in providing
          counselling for students considering studying abroad in countries
